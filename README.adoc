...
However, preparing such a marker and adding it to every fatal error can be a bit of tedious.
...
in applications which use any kind of concurrency as it leads to the interleaving of logs.
